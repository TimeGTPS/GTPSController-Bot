...
module.exports = {
    ...
    async run (client, message, args){
        ...
        .addField(`${defaut_prefix}showgems`, '[Player] (Shows Amount the Gems of A Specific User)')
        .addField(`${defaut_prefix}showxp`, '[Player] (Shows XP of A Specific User)')
        .addField(`${defaut_prefix}showlevel`, '[Player] (Shows Level of A Specific User)')
